   ...
   <div className="landing">
     <div className="welcome-container">
      <div className="welcome-text">
        <h1>Pet L<i className="fas fa-paw"></i>ve</h1>
        <h2>Manage everything pet in one place</h2>
        <button><Link to="/login" className="link-btn" >SIGN IN</Link></button>
        </div>
        <Link to="/register">New User? Sign up here</Link>
       </div>
       <div className="feature-area">
         <FeatureBox icon="fas fa-user-circle fa-5x" title="Build Pet Profiles" description='Build profiles for all your fur babies in your family.' />
         <FeatureBox icon="fas fa-notes-medical fa-5x" title="Store and Track Pet Health Records" description="Never forget when your pet's next round of vaccines are due." />
